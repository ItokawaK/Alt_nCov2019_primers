###  🔔 This repository is **deprecated** now. Further update will no longer be added except correcting serious error if any. Please check the new [fork](https://github.com/nasasaki/Alt_nCov2019_primers) for up to date information. Thank you.
